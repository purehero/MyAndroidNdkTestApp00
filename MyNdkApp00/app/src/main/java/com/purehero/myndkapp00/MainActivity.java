...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch( view.getId()) {
            case R.id.MyButton00:
                break;
            case R.id.MyButton01: showAlertDialog( this, 0, "[70007] [Auto Clicker for IDLE Game] 툴이 감지되었습니다. 해당 툴 삭제 후 앱을 다시 실행해 주시기 바랍니다. (설정의 앱관리에서 삭제할 수 있습니다)");
                break;
    ...
    private void showAlertDialog(Context context, int type, Object msg ) {
